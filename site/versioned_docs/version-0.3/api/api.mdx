...
<ApiField
  name="targetRefs"
  type="[LocalPolicyTargetReferenceWithSectionName](https://gateway-api.sigs.k8s.io/reference/api-spec/main/spec/#localpolicytargetreferencewithsectionname) array"
  required="false"
...
/><ApiField
  ...
  type="[LocalObjectReference](https://gateway-api.sigs.k8s.io/reference/api-spec/main/spec/#localobjectreference)"
  required="false"
