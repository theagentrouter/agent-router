...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MCPResourceIntegrity) DeepCopyInto(out *MCPResourceIntegrity) {
	*out = *in
	if in.Digests != nil {
		in, out := &in.Digests, &out.Digests
		*out = make(map[string]MCPResourceIntegrityDigest, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MCPResourceIntegrity.
func (in *MCPResourceIntegrity) DeepCopy() *MCPResourceIntegrity {
	if in == nil {
		return nil
	}
	out := new(MCPResourceIntegrity)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MCPRouteBackendRef) DeepCopyInto(out *MCPRouteBackendRef) {
	*out = *in
	...
	if in.ResourceIntegrity != nil {
		in, out := &in.ResourceIntegrity, &out.ResourceIntegrity
		*out = new(MCPResourceIntegrity)
		(*in).DeepCopyInto(*out)
	}
