...
func (in *MCPRouteBackendRef) DeepCopyInto(out *MCPRouteBackendRef) {
	*out = *in
	...
	if in.ToolIntegrity != nil {
		in, out := &in.ToolIntegrity, &out.ToolIntegrity
		*out = new(MCPToolIntegrity)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MCPToolIntegrity) DeepCopyInto(out *MCPToolIntegrity) {
	*out = *in
	if in.Digests != nil {
	...
	if in.OnMismatch != nil {
		in, out := &in.OnMismatch, &out.OnMismatch
		*out = new(MCPToolIntegrityAction)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MCPToolIntegrity.
func (in *MCPToolIntegrity) DeepCopy() *MCPToolIntegrity {
	if in == nil {
		return nil
	}
	out := new(MCPToolIntegrity)
